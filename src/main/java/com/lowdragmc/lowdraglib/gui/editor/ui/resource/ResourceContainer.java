...
public class ResourceContainer<T, C extends Widget> extends WidgetGroup {
    ...
    protected PropertyDispatch.TriFunction<String, Object, Position, IGuiTexture> draggingRenderer;
    @Setter
    ...
    public <D> ResourceContainer<T, C> setDragging(Function<String, D> draggingMapping, PropertyDispatch.TriFunction<String, D, Position, IGuiTexture> draggingRenderer) {
        this.draggingMapping = draggingMapping::apply;
