...
/* loaded from: photon-forge-1.19.2-1.0.7.a.jar:META-INF/jars/ldlib-forge-1.19.2-1.0.21.a.jar:com/lowdragmc/lowdraglib/gui/editor/Icons.class */
public class Icons {
    private static final BiFunction<String, String, ResourceTexture> CACHE = Util.m_143821_(modID, name -> {
        return new ResourceTexture("%s:textures/gui/icon/%s.png".formatted(new Object[]{modID, name}));
    });
